...
lazy val sierra_bibs_to_sns = doSharedSierraSetup(project, "sierra_adapter/sierra_bibs_to_sns")
  .settings(libraryDependencies ++= Dependencies.sierraBibsToSnsDependencies)
