...
case class DisplayResultList(
  ...
  @ApiModelProperty(value = "List of things in the current page") results: Array[DisplayWork]) {
  @ApiModelProperty(readOnly = true, value = "A type of thing") @JsonProperty("type") val ontologyType: String = "ResultList"
}
