...
//    val contributors = transformer.getContributors(bibData)
//
//    contributors should contain only Contributor(agent = Unidentifiable(
//      Person(
//        label = name,
//        prefix = Some(prefix),
...
//    val contributors = transformer.getContributors(bibData)
//
//    contributors should contain only Unidentifiable(
...
//      "Person",
//      code)
//    contributors should contain only Identifiable(
//      Person(label = name),
...
//    contributors should contain only Identifiable(Person(label = name), sourceIdentifier = sourceIdentifier, identifiers = List(sourceIdentifier))
//  }
//
//  it(
...
//    val contributors = transformer.getContributors(bibData)
//
//    contributors should contain only Unidentifiable(Organisation(label = name))
//  }
//
