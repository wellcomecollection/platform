...
case class MiroTransformableData(
  ...
  @JsonKey("image_library_ref_department") libraryRefDepartment: Option[List[String]],
  @JsonKey("image_library_ref_id") libraryRefId: Option[List[String]],
  @JsonKey("image_award") award: Option[List[String]],
  @JsonKey("image_award_date") awardDate: Option[List[String]]
)
