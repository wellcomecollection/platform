...
class IdEmbedderTests
  ...
  it("should set the canonicalId given by the IdentifierGenerator on the work") {
    ...
    val originalWork = Work(title = Some("crap"), sourceIdentifier = identifier, canonicalId = None)
  ...
  it("should add canonicalIds to all items") {
    ...
    val originalWork = Work(title = Some("crap"), sourceIdentifier = identifier, canonicalId = None, items = List(originalItem1, originalItem2))
