locals {
  ...
  transformer_container_image = "${module.ecr_repository_transformer.repository_url}:812cd0ae5e02905f3b13ae9a5a24ec5e11ed9c6d"
  recorder_container_image    = "${module.ecr_repository_recorder.repository_url}:864e37937e2134d8b122445550eb284cc1fc5849"
  matcher_container_image     = "${module.ecr_repository_matcher.repository_url}:12605813583097c4438f4c924eca272695427919"
