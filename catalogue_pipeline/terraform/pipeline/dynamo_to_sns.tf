...
module "miro_transformer_dynamo_to_sns" {
  source = "../../../shared_infra/dynamo_to_sns"

  name           = "${var.namespace}_miro"
  src_stream_arn = "${var.vhs_miro_table_stream_arn}"
...
module "sierra_transformer_dynamo_to_sns" {
  ...
  name           = "${var.namespace}_sierra"
  src_stream_arn = "${var.vhs_sierra_table_stream_arn}"
