...
import uk.ac.wellcome.platform.archive.common.modules.config.{CloudwatchConfig, HttpServerConfig}
...
class TestAppConfigModule(
  ...
  @Provides
  def providesHttpServerConfig =
    serverConfig

  @Provides
  def providesMetricsConfig =
    MetricsConfig(
      namespace = "namespace",
  ...
  @Provides
  def providesProgressMonitorConfig =
