...
module "migrator" {
  source = "git::https://github.com/wellcometrust/terraform.git//lambda/prebuilt/vpc?ref=7ad8f0c2a4fcf0b540ebcf4cd51cb2b84af96cd5"
...
module "trigger_migrator" {
  source = "git::https://github.com/wellcometrust/terraform.git//lambda/modules/triggers/sns?ref=7ad8f0c2a4fcf0b540ebcf4cd51cb2b84af96cd5"
