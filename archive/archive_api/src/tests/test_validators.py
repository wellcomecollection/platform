...
#     """
#
#     @pytest.mark.parametrize("bad_url", ["foo", "http://", "//foo"])
...
#         "good_url", ["https://example.org", "http://example.net/foo"]
#     )
#     def test_allows_valid_url(self, good_url):
#         validators.validate_single_url(good_url)
#
#     @pytest.mark.parametrize(
#         "bad_url", ["ftp://example.org/foo", "https://example.net/bar", "http://"]
#     )
...
#
#     @pytest.mark.parametrize(
#         "good_url", ["s3://example-bukkit/example.zip", "https://example.net/foo"]
#     )
#     def test_allows_okay_supported_scheme(self, good_url):
#         validators.validate_single_url(good_url, supported_schemes=["s3", "https"])
#
#     @pytest.mark.parametrize(
#         "bad_url", ["http://#fragment", "https://example.net#another_fragment"]
#     )
...
#     @pytest.mark.parametrize(
#         "good_url",
#         ["https://example.org/foo#bar", "s3://example-bukkit/bucket.zip#baz"],
#     )
...
#     """
#
#     @pytest.mark.parametrize("bad_id", ["foo", "bar", "1234567890", "hwta58gq"])
