...
object UpdateStoredManifestFlow {
  def apply(dataStore: VersionedHybridStore[StorageManifest, EmptyMetadata, ObjectStore[StorageManifest]], ddsSnsConfig: SNSConfig, progressSnsConfig: SNSConfig)(implicit snsClient: AmazonSNS, ec: ExecutionContext) =
  ...
  private def updateStoredManifest(dataStore: VersionedHybridStore[StorageManifest, EmptyMetadata, ObjectStore[StorageManifest]],
