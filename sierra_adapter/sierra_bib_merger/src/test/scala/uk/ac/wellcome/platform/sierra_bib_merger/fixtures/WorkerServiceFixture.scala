...
trait WorkerServiceFixture extends Akka with LocalVersionedHybridStore with MetricsSenderFixture with SNS with SQS {
  def withApp[R](bucket: Bucket, table: Table, queue: Queue, topic: Topic)(testWith: TestWith[SierraBibMergerWorkerService, R]): R =
