...
def id_exception(**kwargs):
    exception = {"cold_store": "", "tandem_vault": "", "catalogue_api": ""}
...
@pytest.mark.parametrize(
    ...
    [
        ...
        collection_image_data(
            collection="images-V", image_library_dept="Archives and Manuscripts"
        ),
        collection_image_data(
            collection="images-M", image_library_dept="Archives and Manuscripts"
        ),
        collection_image_data(
            collection="images-L", image_library_dept="Archives & Manuscripts"
        ),
        collection_image_data(
            collection="images-V", image_library_dept="Archives & Manuscripts"
        ),
        collection_image_data(
            collection="images-M", image_library_dept="Archives & Manuscripts"
        ),
        collection_image_data(
            collection="images-L", image_tech_captured_mode="videodisc"
        ),
        collection_image_data(
            collection="images-V", image_tech_captured_mode="videodisc"
        ),
        collection_image_data(
            collection="images-M", image_tech_captured_mode="videodisc"
        ),
        ...
        image_with_no_info(
            collection="images-L", image_title="Awaiting removal from MIRO as duplicate"
        ),
        image_with_no_info(
            collection="images-V", image_title="Awaiting removal from MIRO as duplicate"
        ),
        image_with_no_info(
            collection="images-M", image_title="Awaiting removal from MIRO as duplicate"
        ),
        image_with_no_info(
            collection="images-L", image_title="Awaiting captions and consent form"
        ),
        image_with_no_info(
            collection="images-V", image_title="Awaiting captions and consent form"
        ),
        image_with_no_info(
            collection="images-M", image_title="Awaiting captions and consent form"
        ),
        image_with_no_info(
            collection="images-L", image_title="Awaiting catalogue details"
        ),
        image_with_no_info(
            collection="images-V", image_title="Awaiting catalogue details"
        ),
        image_with_no_info(
            collection="images-M", image_title="Awaiting catalogue details"
        ),
        ...
        image_with_no_info(
            collection="images-L", image_title="No info available about this object"
        ),
        image_with_no_info(
            collection="images-V", image_title="No info available about this object"
        ),
        image_with_no_info(
            collection="images-M", image_title="No info available about this object"
        ),
...
def test_is_cold_store(collection, image_data):
    assert sort_image(
        collection, image_data, _empty_id_exceptions(), _empty_contrib_exceptions()
    ) == [Decision.cold_store]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        collection_image_data(
            collection="images-V", image_library_dept="Public programmes"
        ),
        collection_image_data(
            collection="images-M", image_library_dept="Public programmes"
        ),
        collection_image_data(
            collection="images-L",
            image_tech_scanned_date="02/03/2016",
        ...
        collection_image_data(
            collection="images-L", image_use_restrictions="Top-secret"
        ),
        collection_image_data(
            collection="images-V", image_use_restrictions="Top-secret"
        ),
        collection_image_data(
            collection="images-M", image_use_restrictions="Top-secret"
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        collection_image_data(
            collection="images-M",
            image_use_restrictions="CC-BY-NC-ND",
            image_innopac_id=None,
        ),
        collection_image_data(
            collection="images-L",
            image_use_restrictions="CC-BY-NC-ND",
        ...
        collection_image_data(
            collection="images-L", image_tech_scanned_date="01/03/2016"
        ),
        collection_image_data(
            collection="images-L", image_tech_scanned_date="29/02/2016"
        ),
        ...
        collection_image_data(
            collection="images-L", image_use_restrictions="CC-BY-NC-ND"
        ),
        collection_image_data(
            collection="images-V", image_use_restrictions="CC-BY-NC-ND"
        ),
        collection_image_data(
            collection="images-M", image_use_restrictions="CC-BY-NC-ND"
        ),
        collection_image_data(
            collection="images-L",
            image_use_restrictions="CC-BY-NC-ND",
...
@pytest.mark.parametrize(
    ...
    [
        collection_image_data(
            collection="images-L", image_tech_scanned_date="02/03/2016"
        ),
        collection_image_data(
            collection="images-L", image_tech_scanned_date="30/06/2018"
        ),
    ],
)
...
@pytest.mark.parametrize(
    "collection, image_data, id_exceptions, expected_decisions",
    [
        (
            "images-L",
            update_image_data(
                image_no_calc="V0002006", image_tech_scanned_date="02/03/2016"
            ),
        ...
        (
            "images-L",
            update_image_data(
                image_no_calc="V0002006", image_library_dept="Archives and Manuscripts"
            ),
            [
                id_exception(
                    miro_id="V0002006", tandem_vault="true", catalogue_api="true"
                )
            ],
            [Decision.tandem_vault, Decision.catalogue_api],
        ),
        (
            ...
            [
                id_exception(
                    miro_id="V0002006", tandem_vault="false", catalogue_api="true"
                )
            ],
            [Decision.catalogue_api],
        ),
...
def test_id_exceptions_should_override_rules(
    collection, image_data, id_exceptions, expected_decisions
):
    assert (
        sort_image(collection, image_data, id_exceptions, _empty_contrib_exceptions())
        == expected_decisions
    )
...
@pytest.mark.parametrize(
    "collection, image_data, contrib_exceptions, expected_decisions",
    [
        (
            "images-A",
        ...
        (
            "images-L",
            update_image_data(
                image_use_restrictions="CC-BY-NC-ND", image_innopac_id=None
            ),
            _create_csv("""A,B\nAAA,BBB\nDDD,CCC"""),
            [Decision.catalogue_api],
        ),
...
def test_contrib_exceptions_should_override_rules(
    collection, image_data, contrib_exceptions, expected_decisions
):
    assert (
        sort_image(collection, image_data, _empty_id_exceptions(), contrib_exceptions)
        == expected_decisions
    )
...
@pytest.mark.parametrize("image_no_calc", ["L0000001FX", "L1234567FX"])
...
class TestWellcomeImageAwards:
    ...
    @pytest.mark.parametrize(
        "award", ["Biomedical Image Awards", ["Wellcome Image Awards"]]
    )
