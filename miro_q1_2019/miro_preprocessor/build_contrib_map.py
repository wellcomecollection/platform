...
OUTFILE = os.path.join(ROOT, "common/src/main/resources/miro_contributor_map.json")


client = boto3.client("s3")
contributor_xml_object = client.get_object(Bucket="miro-data", Key="contributors.xml")
...
changes = {
    ...
    "CRR": ("Amanda Carr &", "Amanda Carr"),
    "GRE": ("David Gregory&Debbie Marshall", "David Gregory & Debbie Marshall"),
    "REV": (
        "'EM Unit, UCL Medical School, Royal Free Campus'",
        "EM Unit, UCL Medical School, Royal Free Campus",
    ),
    "THA": ("Dr Thanuja Perera,U.Aberdeen", "Dr Thanuja Perera, U.Aberdeen"),
    ...
    "FCI": ("[scientist's name], Francis Crick Institute", "Francis Crick Institute"),
    "HWU": ("[scientist's name], Heriot-Watt University", "Heriot-Watt University"),
    "ICI": ("[scientist's name], Imperial College London", "Imperial College London"),
    "KCL": ("[individual scientists name], KCL", "KCL"),
    "MIT": (
        "[scientist's name(s)], [institute name if applicable], copyright MIT",
        "MIT",
    ),
    "MNS": ("[scientist's name], Monash University", "Monash University"),
    "RCI": (
        "[creator name], Royal College of Surgeons in Ireland",
        "Royal College of Surgeons in Ireland",
    ),
    "ULI": ("[scientist's name], University of Lincoln", "University of Lincoln"),
}
