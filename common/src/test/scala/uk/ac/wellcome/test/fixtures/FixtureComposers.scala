...
trait FixtureComposers {
  ...
  implicit def OneArgFixtureComposer[L1, L2, R] =
    new FixtureComposer[L1, (L1, L2), Function1[L1, Fixture[L2, R]], R] {
      ...
      override def compose(
        ...
        function: Function1[L1, Fixture[L2, R]]): Fixture[(L1, L2), R] =
        (testWith: TestWith[(L1, L2), R]) =>
          fixture1 { loan1 =>
  ...
  implicit def TwoArgFixtureComposer[L1, L2, L3, R] =
    new FixtureComposer[
      (L1, L2),
      (L1, L2, L3),
      Function2[L1, L2, Fixture[L3, R]],
      R] {

      override def compose(fixture1: Fixture[(L1, L2), R],
                           function: Function2[L1, L2, Fixture[L3, R]])
        : Fixture[(L1, L2, L3), R] =
  ...
  implicit def ThreeArgFixtureComposer[L1, L2, L3, L4, R] =
    new FixtureComposer[
      ((L1, L2), L3),
      (L1, L2, L3, L4),
      Function3[L1, L2, L3, Fixture[L4, R]],
      R] {

      override def compose(fixture1: Fixture[((L1, L2), L3), R],
                           function: Function3[L1, L2, L3, Fixture[L4, R]])
