...
class UnidentifiedWorkTest extends FunSpec with Matchers with JsonTestUtil with PropertyChecks {

  implicit val noShrink = Shrink.shrinkAny[UnidentifiedWork]

  it("json serialisation and deserialisation doesn't change the original UnidenfiedWork"){
