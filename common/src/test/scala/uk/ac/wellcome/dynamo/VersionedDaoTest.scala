...
class VersionedDaoTest
  ...
  describe("get a record") {
    it("returns a future of a record if its in dynamo") {
      ...
      Scanamo.put(dynamoDbClient)(tableName)(testVersioned)(Versioned.toVersionedDynamoFormat[TestVersioned].enrichedDynamoFormat)
  ...
  describe("update a merged sierra record") {
    ...
    it("does not update an existing record if the update has a lower version") {
      ...
      Scanamo.put(dynamoDbClient)(tableName)(newerTestVersioned)(Versioned.toVersionedDynamoFormat[TestVersioned].enrichedDynamoFormat)
