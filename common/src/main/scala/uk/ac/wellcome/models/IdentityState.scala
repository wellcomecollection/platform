...
case class Identified[T](agent: T, canonicalId: String) extends IdentityState[T] with IdentifiedOrUnidentifiable[T]
case class Identifiable[T](agent: T, sourceIdentifier: SourceIdentifier) extends IdentityState[T] with IdentifieableOrUnidentifiable[T]
