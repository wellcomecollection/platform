...
class VersionedDao @Inject()(
  ...
  private def putRecord[T<: Versioned](record: T)(implicit evidence: VersionedDynamoFormatWrapper[T], versionUpdater: VersionUpdater[T]) = {
  ...
  def updateRecord[T<: Versioned](record: T)(implicit evidence: VersionedDynamoFormatWrapper[T], versionUpdater: VersionUpdater[T]): Future[Unit] = Future {
