...
locals {
  ...
  romulus_api_release_id   = "${var.production_api == "romulus" ? var.pinned_romulus_api : var.pinned_remus_api}"
  romulus_nginx_release_id = "${var.production_api == "romulus" ? var.pinned_romulus_api_nginx : var.pinned_remus_api_nginx}"

  remus_api_release_id       = "${var.production_api == "romulus" ? var.pinned_romulus_api : var.pinned_remus_api}"
  remus_app_nginx_release_id = "${var.production_api == "romulus" ? var.pinned_romulus_api_nginx : var.pinned_remus_api_nginx}"
}
