...
module "xml_to_json_run_task" {
  ...
  cluster_name        = "${data.terraform_remote_state.pipeline.ecs_services_cluster_name}"
...
module "miro_image_to_dynamo" {
  ...
  miro_data_table_arn            = "${data.terraform_remote_state.pipeline.table_miro_data_arn}"
  miro_data_table_name           = "${data.terraform_remote_state.pipeline.table_miro_data_name}"
  lambda_error_alarm_arn         = "${data.terraform_remote_state.lambda.lambda_error_alarm_arn}"
}
