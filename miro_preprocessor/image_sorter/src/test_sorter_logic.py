...
@pytest.mark.parametrize('collection, image_data', [
    ...
    collection_image_data(collection='images-L', image_library_dept="Archives & Manuscripts"),
    collection_image_data(collection='images-V', image_library_dept="Archives & Manuscripts"),
    collection_image_data(collection='images-M', image_library_dept="Archives & Manuscripts"),
