...
object Dependencies {
  ...
  val dynamoDependencies: Seq[ModuleID] = Seq(
    ...
    "com.amazonaws" % "DynamoDBLocal" % versions.dynamoDbLocal % "test"
  )
  ...
  val idminterDependencies: Seq[ModuleID] = commonDependencies ++ dynamoDependencies
