...
module "calm_adapter" {
  ...
  nginx_uri          = "${module.ecr_repository_nginx_services.repository_url}:latest"
...
module "api" {
  ...
  nginx_uri          = "${module.ecr_repository_nginx_api.repository_url}:latest"
...
module "loris" {
  ...
  nginx_uri          = "${module.ecr_repository_nginx_loris.repository_url}:latest"
  listener_https_arn = "${module.api_alb.listener_https_arn}"
  listener_http_arn  = "${module.api_alb.listener_http_arn}"
  infra_bucket       = "${var.infra_bucket}"
