...
module "calm_adapter" {
  ...
  listener_arn      = "${module.services_alb.listener_https_arn}"
...
module "api" {
  ...
  listener_arn      = "${module.api_alb.listener_https_arn}"
...
module "grafana" {
  ...
  listener_arn      = "${module.monitoring_alb.listener_https_arn}"
