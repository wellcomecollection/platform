...
module "api_romulus" {
  ...
  config_vars = {
    ...
    es_index    = "${var.production_api == "romulus" ? var.es_config["index"] : var.es_config_stage["index"]}"
...
module "api_remus" {
  ...
  config_vars = {
    ...
    es_index    = "${var.production_api == "remus" ? var.es_config["index"] : var.es_config_stage["index"]}"
